Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'Eureka', '~> 4.0'
    sp.dependency 'OperaSwift', '~> 3.0.1'
    sp.dependency 'RealmSwift', '~> 3.0.0'
    sp.dependency 'RxRealm', '~> 0.7.3'
    sp.dependency 'RxSwift', '~> 4.0.0'
    sp.dependency 'Decodable', '~> 0.6'
  end

  s.subspec 'Onboarding' do |sp|
    sp.ios.source_files = 'Onboarding/Onboarding/**/*.{swift}'
    sp.dependency 'Ahoy', '~> 2.0'
  ...
  s.subspec 'PushNotifications' do |sp|
    ...
    sp.dependency 'Ecno', '~> 2.0'
    sp.dependency 'Whisper'#, '~> 5.1'
    sp.dependency 'SwiftyMatter/Core'
  end
  ...
  s.subspec 'RouteHandling' do |sp|
    ...
    sp.dependency 'SwiftyMatter/Core'
    sp.dependency 'URLNavigator', '~> 1.3'
  end
